...
router.post("/aircrafts",requireAuth,requireRole("ADMIN", "SUPERVISOR", "OPS_STAFF"),asyncHandler(createAircraftHandler));
router.patch("/aircrafts/:id",requireAuth,requireRole("ADMIN", "SUPERVISOR", "OPS_STAFF"),asyncHandler(updateAircraftHandler));
router.delete("/aircrafts/:id",requireAuth,requireRole("ADMIN", "SUPERVISOR", "OPS_STAFF"),asyncHandler(deleteAircraftHandler));
